...
public class TeacherMonthReportViewController implements FxInitializable {
    ...
    @Autowired
    public TeacherMonthReportViewController(MessageSource messageSource,
...
//        comboBoxMonth.getSelectionModel().selectFirst();
    ...
    void doReport(ActionEvent event) {
        ...
        exportTeacherReportSettings.put("xlsArea", "ВедомостьМесяцПреподаватель!A1:AI20");
        ...
        String fileName = "ОтчётыПоПреподавателям" + comboBoxMonth.getValue() + ".xls";
