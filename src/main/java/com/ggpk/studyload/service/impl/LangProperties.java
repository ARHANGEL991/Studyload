...
public enum LangProperties {
    ...
    SAVED("javafx.notification.saved"),
    SAVING("javafx.action.saving"),
    SUCCESS("javafx.notification.success"),
    ...
    ERROR_CREATE_REPORT_WITH_PARAM("javafx.notification.error.report.create"),
    ERROR_FILE_IS_OPENED("javafx.notification.error.file.isOpened"),
    ...
    SUCESSED_SAVE_WITH_PARAM("javafx.notification.success.add"),
    SUCESSED_SAVED("javafx.notification.success.save"),
    SUCESSED_EXPORTED("javafx.notification.success.exported"),
    SUCESSED_IMPORTED("javafx.notification.success.imported"),
